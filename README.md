...
## 2. Database Setup
The Hospital Management dataset is downloaded from [Kaggle](https://www.kaggle.com/datasets/airbnb/seattle). The import of csv tables and the establishment of relationships among tables are achieved by the following SQL script:
